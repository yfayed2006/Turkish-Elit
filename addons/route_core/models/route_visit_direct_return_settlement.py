...
class RouteVisit(models.Model):
    ...
    def _compute_direct_stop_summary(self):
        for rec in self:
            ...
            if hasattr(rec, "_get_direct_stop_returns"):
    ...
    def action_ux_create_direct_return(self):
        ...
        sale_orders = self._get_direct_stop_sale_orders() if hasattr(self, "_get_direct_stop_sale_orders") else self.env["sale.order"]
        action = {
            "type": "ir.actions.act_window",
