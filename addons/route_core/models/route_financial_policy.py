...
class RouteVisit(models.Model):
    ...
    def _build_consignment_category_commission_html(self):
        ...
        for line in lines:
            ...
            mobile_cards.append(
                "".join([
                    ...
                    "<div class='route_commission_mobile_card_head'>",
                    "<div class='route_commission_mobile_card_identity'>",
                    "<div class='route_commission_mobile_card_title'>", category_name, "</div>",
                    "<div class='route_commission_mobile_card_subtitle'>Sold Qty: ", qty(sold_qty), "</div>",
                    "</div>",
                    "<div class='route_commission_mobile_card_net'><span>Net Payable</span><strong>", money(net_payable_amount), "</strong></div>",
                    "</div>",
                    "<div class='route_commission_mobile_grid route_commission_mobile_key_grid'>",
        ...
        mobile_cards.append(
            "".join([
                ...
                "<div class='route_commission_mobile_card_subtitle'>Sold Qty: ", qty(breakdown.get("total_sold_qty", 0.0)), "</div>",
                "</div>",
                "<div class='route_commission_mobile_card_net'><span>Net Payable</span><strong>", money(breakdown.get("total_net_payable_amount", 0.0)), "</strong></div>",
                "</div>",
                "<div class='route_commission_mobile_grid route_commission_mobile_key_grid'>",
        ...
        return "".join([
            ...
            "</div>",
            "<style>",
            ".route_commission_breakdown{grid-column:1/-1;width:100%;max-width:100%;box-sizing:border-box;border:1px solid #dbe3ec;border-radius:14px;background:#fff;padding:12px;margin:10px 0 14px 0;clear:both;}",
            ".route_commission_form_full_width,.route_commission_form_full_width .o_field_widget,.route_commission_form_full_width .o_field_html,.route_commission_form_full_width .o_readonly_modifier,.route_pda_payment_section .route_commission_breakdown,.route_pda_statement_section .route_commission_breakdown{grid-column:1/-1;width:100%;max-width:100%;}",
            ...
            ".route_commission_mobile_card{border:1px solid #e5e7eb;border-radius:12px;background:#fff;margin:8px 0;padding:9px;}",
            ".route_commission_mobile_total{background:#f8fafc;border-color:#cbd5e1;}",
            ".route_commission_mobile_card_head{display:flex;gap:8px;align-items:stretch;justify-content:space-between;margin-bottom:8px;}.route_commission_mobile_card_identity{min-width:0;flex:1 1 auto;}.route_commission_mobile_card_title{font-weight:800;color:#0f172a;margin-bottom:3px;font-size:14px;line-height:1.25;}.route_commission_mobile_card_subtitle{font-size:11px;color:#64748b;font-weight:700;}.route_commission_mobile_card_net{flex:0 0 38%;background:#ecfeff;border:1px solid #bae6fd;border-radius:10px;padding:7px 8px;display:flex;flex-direction:column;justify-content:center;}.route_commission_mobile_card_net span{display:block;font-size:10px;text-transform:uppercase;letter-spacing:.35px;color:#64748b;font-weight:800;margin-bottom:3px;}.route_commission_mobile_card_net strong{display:block;font-size:15px;color:#0f766e;font-weight:900;line-height:1.2;word-break:break-word;}",
            ".route_commission_mobile_grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;}",
            ".route_commission_mobile_grid div{background:#f8fafc;border:1px solid #eef2f7;border-radius:10px;padding:7px 8px;min-width:0;}",
            ...
            ".route_commission_mobile_net strong{color:#0f766e!important;font-size:15px;}.route_commission_mobile_formula{margin-top:7px;font-size:11px;color:#64748b;background:#f8fafc;border:1px dashed #cbd5e1;border-radius:9px;padding:6px 8px;line-height:1.35;}",
            "@media(max-width:768px){.route_commission_breakdown{width:100%!important;max-width:100%!important;padding:10px;margin:10px 0 14px 0;}.route_commission_title{font-size:15px;}.route_commission_hint{font-size:12px;line-height:1.35;}.route_commission_desktop_table{display:none;}.route_commission_mobile_cards{display:block;}.route_commission_mobile_grid{grid-template-columns:repeat(2,minmax(0,1fr));}.route_mobile_detail_grid>.route_commission_form_full_width{grid-column:1/-1!important;width:100%!important;}.route_mobile_detail_grid .route_commission_breakdown{width:100%!important;max-width:100%!important;}}",
            "@media(max-width:390px){.route_commission_mobile_card_head{gap:6px;}.route_commission_mobile_card_net{flex-basis:42%;padding:6px;}.route_commission_mobile_grid{gap:6px;}.route_commission_mobile_grid strong{font-size:12px;}.route_commission_mobile_card{padding:8px;}}",
            "</style>",
        ])
    ...
    def _prepare_sale_order_line_vals(self):
        ...
        # Consignment commission is a settlement deduction, not a sales-order line discount.
        # Keep the commercial Sale Order at the real selling price so the salesperson,
        # supervisor, and accounting team can read gross sales separately from outlet
        # commission in the visit settlement/receipt/statement. Direct-sale pricelist
        # discounts are still handled by the direct-sale specific sale.order logic.
